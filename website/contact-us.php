                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="contact-info-wrapper text-center mb-30">
                            ...
                            <div class="contact-info-content">
                                <h4>Civil Lines,Indore</h4>
                                <p>Behind Kali Mandir, 254234</p>
                                <p><a href="#">billys@gmail.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="contact-info-wrapper text-center mb-30">
                            ...
                            <div class="contact-info-content">
                                ...
                                <p><a href="#">Support.billys@gmail.com </a></p>
                                <p><a href="#">letsorder@gmail.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
